...
public class CompleteMutationTest {
    ...
    private CompleteMutation completeMutation;
    ...
    public void limitedMultiGenMutateOnlyHeightAndChest() {
        List<Allele> mutatedAlleles = completeMutation.mutate(dad, itemsProvider);
        ...
        assertEquals("Helmet should have mutated", 10, ((Item) mutatedAlleles.get(4)).getId());
        assertEquals("Weapon should have mutated", 10, ((Item) mutatedAlleles.get(5)).getId());
    }
}
